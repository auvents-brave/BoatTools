...
private enum PriorityResolver {
  ...
  private static func atmosphereRank(pgns: [UInt32], nmea0183Types: [String], source: SourceKind)
    -> Int
  {
    switch source {
...
public final class BoatMetricStore {
  ...
  /// - Returns: A `Task` that you can cancel to stop consumption.
  @discardableResult
  public nonisolated func pipeSignalK<S: AsyncSequence & Sendable>(_ stream: S) -> Task<
    Void, any Error
  >
  where S.Element == NMEAFrame {
    Task { [weak self] in
  ...
  /// - Returns: A `Task` that you can cancel to stop consumption.
  @discardableResult
  public nonisolated func pipeMetrics<S: AsyncSequence & Sendable>(_ stream: S) -> Task<
    Void, any Error
  >
